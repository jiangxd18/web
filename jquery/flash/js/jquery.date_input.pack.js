DateInput = (function($) {
	...
	DateInput.prototype = {
		...
		insideSelector: function(event) {
			...
			var theoffset = $('#control1').offset();
			var theoffset2 = $('.custom-menu-info').offset();
			offset.right = theoffset2.left + offset.left + this.dateSelector.outerWidth() + 20;
			offset.bottom = 1137;
			offset.left = offset.left + theoffset2.left;
			offset.top = 928;
		...
		setPosition: function() {
			...
			this.rootLayers.css({
				top: 157,
				left: offset.left-$('.custom-menu-info').offset().left-20
			});
			if (this.ieframe) {
				this.ieframe.css({
